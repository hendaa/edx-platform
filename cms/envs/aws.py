...
# Edraak (config): Allow configuring CSRF cookie settings from the configuration repo
...
# Edraak (config): Allow defining admins as tuple
...
# Edraak (i18n): Allow single-click ar/en switching
...
# Edraak (mathjax): Use Arabic-supported MathJax
